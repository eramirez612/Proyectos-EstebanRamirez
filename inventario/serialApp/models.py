...
class Licencia(models.Model):
    ...
    nro_licencia_windows = models.CharField(max_length=100, unique=True, null=False)
    #----------------------------------------------------------------#
    ...
    nro_licencia_office = models.CharField(max_length=100, unique=True, null=False)
    #----------------------------------------------------------------#
    def __str__(self):
        return self.nro_licencia_windows
