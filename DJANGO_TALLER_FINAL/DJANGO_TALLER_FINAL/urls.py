...
urlpatterns = [
    ...
    path('institutos/', views.institucion_list),
    path('institutos/<int:id>', views.institucion_detalle),
    path('inscritosDB/', views.inscritosDB),
    path('inscritos/', views.ListaInscritos.as_view()),
    path('inscritos/<int:pk>', views.DetalleInscritos.as_view()),
]
