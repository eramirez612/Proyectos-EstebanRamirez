"""
Django settings for proyecto_contador_2 project.
...
SECRET_KEY = 'django-insecure-(-*=i4z&#+j-^#@fs5$1cenw+-u2_gglc+0&6h3#o5$*%6+!2o'
...
WSGI_APPLICATION = 'proyecto_contador_2.wsgi.application'
